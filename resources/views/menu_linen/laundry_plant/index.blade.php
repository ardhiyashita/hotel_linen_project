        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Laundry Plant</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <a href="{{ route('laundry_plant_create') }}" class="btn btn-primary btn-sm" style="width: 200px;"> 
                ...
                <thead style="font-size: 12px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $val->phone }}</td>
                                <td>{{ $val->email }}</td>
                                <td>{{ $val->linen_center }}</td>
                                <td>
                                  <form action="{{ route('laundry_plant_delete', $val->id) }}" method="POST">
                                    <div class="" role="group" aria-label="Basic example">
                                    @csrf
                                    <a class="btn btn-warning btn-sm" href="{{ route('laundry_plant_update', $val->id) }}">
                                      <i class="fas fa-edit"></i>
                                      </a>
                                    <a class="btn btn-success btn-sm" href="{{ route('laundry_plant_read', $val->id) }}">
