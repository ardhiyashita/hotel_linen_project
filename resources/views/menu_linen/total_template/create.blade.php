                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            Linen Code
                            <input class="form-control form-control-sm" name="linen_code" type="text" placeholder="-- linen_code --">
                        </div>
                        @error('linen_code')
                        ...
                        <div class="form-group">
                            Template Name
                            <input class="form-control form-control-sm" name="template_name" type="text" placeholder="-- template name --">
                        </div>    
                        @error('template_name')
                        <div class="alert alert-danger" role="alert">{{$message}}</div>
                        @enderror
                        ...
                        <div class="form-group">
                            ...
                            <option>-- Select Linen Type --</option>
                                ...
                                <option value="{{ $item->id }}">{{ $item->linen_code }}</option>
                            @endforeach
                        </select>
                        </div>
                        @error('linen_type')
                    ...
                    <div class="form-group">
                        Ownership
                        <input class="form-control form-control-sm" name="ownership" type="text" placeholder="-- ownership --">
                    </div>
                    @error('ownership')
                    <div class="alert alert-danger" role="alert">{{$message}}</div>
                    @enderror
                  ...
                  @enderror
                    ...
                    <div class="form-group">
                        Linen Condition
                        <input class="form-control form-control-sm" name="linen_condition" type="text" placeholder="-- linen condition --">
                    </div>
