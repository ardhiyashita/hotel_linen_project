                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    Tag ID
                                                    <input class="form-control form-control-sm" name="tag_id"
                                                        type="text" placeholder="-- tag ID --">
                                                </div>
                                                @error('tag_id')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="selectpicker form-control form-control-sm"
                                                        name="template" id="template" data-live-search="true">
                                                        <option>-- Select Template --</option>
                                                        @foreach ($template as $item)
                                                            <option value="{{ $item->id }}">{{ $item->template_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    Linen Name
                                                    <input class="form-control form-control-sm" name="linen_name"
                                                        type="text" placeholder="-- linen name --">
                                                </div>
                                                @error('linen_name')
                                                    <div class="alert alert-danger" role="alert">{{ $message }}</div>
                                                @enderror
                                                ...
                                                <div class="form-group">
                                                    Serial number
                                                    <input class="form-control form-control-sm" name="serial_number"
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="selectpicker form-control form-control-sm"
                                                        ...
                                                        @foreach ($linen_type as $item)
                                                            <option value="{{ $item->id }}">{{ $item->linen_type }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    Linen category
                                                    <select class="selectpicker form-control form-control-sm"
                                                        name="linen_category" id="linen_category"
                                                        data-live-search="true">
                                                        <option>-- Select Linen category --</option>
                                                        @foreach ($linen_category as $item)
                                                            <option value="{{ $item->id }}">{{ $item->linen_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    Ownership
                                                    <select class="selectpicker form-control form-control-sm"
                                                        name="ownership" id="ownership" data-live-search="true">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                ...
                                                <a href="{{ route('linen_index') }}" class="btn bg-primary"
                                                    style="width: 200px;">
            ...
            $('#template').change(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $('[name="supplier"]').val(res.supplier);
                        $('[name="year"]').val(res.year);
                        $('[name="quarter"]').val(res.quarter);
                        $('[name="linen_type"]').val(res.id_linen_type).change();
                        $('[name="sew_by"]').val(res.sew_by);
