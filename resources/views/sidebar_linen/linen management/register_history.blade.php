...
@section('title', 'Total Register Linen')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Total Register Linen</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
              <li class="breadcrumb-item active">Total Register Linen</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">             
                ...
                <thead style="font-size: 12px;">
                            <tr>
                                ...
                                <th class="border-top-0" style="text-align: center">Register date</th>
                                <th class="border-top-0" style="text-align: center">Template code</th>
                        ...
                        <tbody style="font-size: 12px;">
                            @foreach($data as $val)
                            <tr>
                                <td>{{ $data2->register_date}}</td>
                                <td>{{ $data2->template_code }}</td>
