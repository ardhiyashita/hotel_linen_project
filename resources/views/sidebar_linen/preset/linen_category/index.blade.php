        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <a href="{{ route('linen_category_create') }}" class="btn btn-primary btn-sm" style="width: 200px;"> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('linen_category_delete', $val->id) }}" method="POST">
                                        ...
                                        @csrf
                                        <a class="btn btn-warning btn-sm" href="{{ route('linen_category_update', $val->id) }}">
                                          <i class="fas fa-edit"></i>
                                          </a>
                                          <a class="btn btn-success btn-sm" href="{{ route('linen_category_read', $val->id) }}">
