        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <a href="{{ route('supplier_create') }}" class="btn btn-primary btn-sm" style="width: 200px;"> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('supplier_delete', $val->id) }}" method="POST">
                                        ...
                                        @csrf
                                        <a class="btn btn-warning btn-sm" href="{{ route('supplier_update', $val->id) }}">
                                          <i class="fas fa-edit"></i>
                                          </a>
                                          <a class="btn btn-success btn-sm" href="{{ route('supplier_read', $val->id) }}">
